...
public abstract class AbstractEnviroCarDatasourceCacheUpdate extends DatasourceCacheUpdate {

    private EnviroCarDaoFactory enviroCarDaoFactory;

    public EnviroCarDaoFactory getEnviroCarDaoFactory() {
        return enviroCarDaoFactory;
    }

    public void setEnviroCarDaoFactory(EnviroCarDaoFactory enviroCarDaoFactory) {
