...
public class AdsbToInsertObservation implements MqttInsertObservationConverter<AdsbMessage> {
    ...
    private OmObservation createAltitudeObservation(AdsbMessage message) throws OwsExceptionReport, ParseException {
    ...
    private OmObservation createSpeedObservation(AdsbMessage message) throws OwsExceptionReport, ParseException {
        OmObservation observation = new OmObservation();
    ...
    private OmObservation createTrackObservation(AdsbMessage message) throws OwsExceptionReport, ParseException {
        OmObservation observation = new OmObservation();
    ...
    private SosProcedureDescription createProcedure(AdsbMessage message) {
        return new SosProcedureDescription(new PhysicalSystem().setIdentifier(message.getHex()));
    }
